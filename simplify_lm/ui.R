...
fluidPage(theme = shinytheme("flatly"),
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              sliderInput('Beta', 'For every hour of studying, how many additional points do you expect to gain? (Slope)', min = 0, max = 2, value = 1, step = 0.1), # for every hour that you study, how many extra points do you get?
              ...
              checkboxInput('showlm', div(style = "font-size:15px", "Show estimates from a linear regression"), value = TRUE),
              checkboxInput('show_eq', div(style = "font-size:15px", "Show equation used to generate data"), value = TRUE),
